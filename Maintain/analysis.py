...
# #插入表格
with open('故障细分.csv','w',newline="") as datacsv:
    csvwriter = csv.writer(datacsv,dialect=("excel"))
    csvwriter.writerow(["品牌","Raid卡","硬盘故障","电源报错","电源松动","风扇故障","风扇降速","PCIE中断","温度","机箱入侵","GPU掉卡","GPUError","烤机失败","内存报错","网线故障","IB卡故障","宕机"])
    csvwriter.writerow(
        ["Dell", error_dell_Raid_Raidsas[0], error_dell_Raid_Disk[0], error_dell_Ipmi_PsError[0],
         error_dell_Ipmi_PsLoose[0], error_dell_Ipmi_FanError[0], error_dell_Ipmi_FanLow[0],
         error_dell_Ipmi_PCIE[0], error_dell_Ipmi_Temp[0], error_dell_Ipmi_Chassis[0],
         error_dell_GPU_GpuLost[0], error_dell_GPU_GpuError[0], error_dell_GPU_GpuBurn[0],
         error_dell_Dmesg_Mem[0], error_dell_IB_Cable[0], error_dell_IB_Card[0],
         error_dell_ICMP_Dump[0]])
    csvwriter.writerow(
        ["amax", error_amax_Raid_Raidsas[0], error_amax_Raid_Disk[0], error_amax_Ipmi_PsError[0],
         error_amax_Ipmi_PsLoose[0], error_amax_Ipmi_FanError[0], error_amax_Ipmi_FanLow[0],
         error_amax_Ipmi_PCIE[0], error_amax_Ipmi_Temp[0], error_amax_Ipmi_Chassis[0],
         error_amax_GPU_GpuLost[0], error_amax_GPU_GpuError[0], error_amax_GPU_GpuBurn[0],
         error_amax_Dmesg_Mem[0], error_amax_IB_Cable[0], error_amax_IB_Card[0],
         error_amax_ICMP_Dump[0]])
    csvwriter.writerow(
        ["安擎", error_anqing_Raid_Raidsas[0], error_anqing_Raid_Disk[0], error_anqing_Ipmi_PsError[0],
         error_anqing_Ipmi_PsLoose[0], error_anqing_Ipmi_FanError[0], error_anqing_Ipmi_FanLow[0],
         error_anqing_Ipmi_PCIE[0], error_anqing_Ipmi_Temp[0], error_anqing_Ipmi_Chassis[0],
         error_anqing_GPU_GpuLost[0], error_anqing_GPU_GpuError[0], error_anqing_GPU_GpuBurn[0],
         error_anqing_Dmesg_Mem[0], error_anqing_IB_Cable[0], error_anqing_IB_Card[0],
         error_anqing_ICMP_Dump[0]])
    csvwriter.writerow(
        ["联泰", error_liantai_Raid_Raidsas[0], error_liantai_Raid_Disk[0], error_liantai_Ipmi_PsError[0],
         error_liantai_Ipmi_PsLoose[0], error_liantai_Ipmi_FanError[0], error_liantai_Ipmi_FanLow[0],
         error_liantai_Ipmi_PCIE[0], error_liantai_Ipmi_Temp[0], error_liantai_Ipmi_Chassis[0],
         error_liantai_GPU_GpuLost[0], error_liantai_GPU_GpuError[0], error_liantai_GPU_GpuBurn[0],
         error_liantai_Dmesg_Mem[0], error_liantai_IB_Cable[0], error_liantai_IB_Card[0],
         error_liantai_ICMP_Dump[0]])
    csvwriter.writerow(
        ["曙光", error_shuguang_Raid_Raidsas[0], error_shuguang_Raid_Disk[0], error_shuguang_Ipmi_PsError[0],
         error_shuguang_Ipmi_PsLoose[0], error_shuguang_Ipmi_FanError[0], error_shuguang_Ipmi_FanLow[0],
         error_shuguang_Ipmi_PCIE[0], error_shuguang_Ipmi_Temp[0], error_shuguang_Ipmi_Chassis[0],
         error_shuguang_GPU_GpuLost[0], error_shuguang_GPU_GpuError[0], error_shuguang_GPU_GpuBurn[0],
         error_shuguang_Dmesg_Mem[0], error_shuguang_IB_Cable[0], error_shuguang_IB_Card[0],
         error_shuguang_ICMP_Dump[0]])
    csvwriter.writerow(["浪潮",error_langchao_Raid_Raidsas[0],error_langchao_Raid_Disk[0],error_langchao_Ipmi_PsError[0],error_langchao_Ipmi_PsLoose[0],error_langchao_Ipmi_FanError[0],error_langchao_Ipmi_FanLow[0],error_langchao_Ipmi_PCIE[0],error_langchao_Ipmi_Temp[0],error_langchao_Ipmi_Chassis[0],error_langchao_GPU_GpuLost[0],error_langchao_GPU_GpuError[0],error_langchao_GPU_GpuBurn[0],error_langchao_Dmesg_Mem[0],error_langchao_IB_Cable[0],error_langchao_IB_Card[0],error_langchao_ICMP_Dump[0]])


#插入表格
with open('故障明细.csv','w',newline="") as datacsv:
    csvwriter = csv.writer(datacsv,dialect=("excel"))
    csvwriter.writerow(["品牌","Raid","IPMI","GPU","Dmesg","IB","宕机","其他","硬件故障合计"])
    csvwriter.writerow(
        ["Dell", error_dell_Raid, error_dell_Ipmi, error_dell_GPU,error_dell_Dmesg, error_dell_IB, error_dell_Dump,error_dell_Other[0],error_dell_hardware])
    csvwriter.writerow(
        ["Amax", error_amax_Raid, error_amax_Ipmi, error_amax_GPU,error_amax_Dmesg, error_amax_IB, error_amax_Dump,error_amax_Other[0],error_amax_hardware])
    csvwriter.writerow(
        ["安擎", error_anqing_Raid, error_anqing_Ipmi, error_anqing_GPU,error_anqing_Dmesg, error_anqing_IB, error_anqing_Dump,error_anqing_Other[0],error_anqing_hardware])
    csvwriter.writerow(
        ["联泰", error_liantai_Raid, error_liantai_Ipmi, error_liantai_GPU,error_liantai_Dmesg, error_liantai_IB, error_liantai_Dump,error_liantai_Other[0],error_liantai_hardware])
    csvwriter.writerow(
        ["曙光", error_shuguang_Raid, error_shuguang_Ipmi, error_shuguang_GPU,error_shuguang_Dmesg, error_shuguang_IB, error_shuguang_Dump,error_shuguang_Other[0],error_shuguang_hardware])
    csvwriter.writerow(
        ["浪潮", error_langchao_Raid, error_langchao_Ipmi, error_langchao_GPU,error_langchao_Dmesg, error_langchao_IB, error_langchao_Dump,error_langchao_Other[0],error_langchao_hardware])

error_total_hardwware = error_dell_hardware + error_amax_hardware + error_anqing_hardware + error_liantai_hardware + error_shuguang_hardware + error_langchao_hardware
print("Dell硬件故障数量：",error_dell_hardware)
print("amax硬件故障数量：",error_amax_hardware)
print("anqing硬件故障数量：",error_anqing_hardware)
print("liantai硬件故障数量：",error_liantai_hardware)
print("shuguang硬件故障数量：",error_shuguang_hardware)
print("langchao硬件故障数量：",error_langchao_hardware)
print("所有硬件故障数量：",error_total_hardwware)
